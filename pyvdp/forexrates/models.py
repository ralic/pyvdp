class ForeignExchangeRatesModel(object):
    ...
    :param str destinationCurrencyCode: **Required**. Source currency `ISO code <https://developer.visa.com/request_response_codes#isoCodes>`_.
        3 characters string.
    :param str sourceCurrencyCode: **Required**. Destination currency `ISO code <https://developer.visa.com/request_response_codes#isoCodes>`_.
        3 characters string.
    ...
    :param str acquirerCountryCode: **Optional**. Acquirer `ISO country code <https://developer.visa.com/request_response_codes#isoCodes>`_ 
