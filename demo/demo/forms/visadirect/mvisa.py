...
class CashinPushPaymentsFormPost(forms.Form):
    ...
    sender_name = forms.CharField(label='Sender name', max_length=34, required=True, initial="Mohammed Qasim")
...
class MerchantPushPaymentsFormPost(forms.Form):
    ...
    sender_account_number = forms.CharField(label='Sender account number', max_length=34, required=True, initial="4027290077881587")
